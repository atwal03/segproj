...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    .line 1469
    .local v5, "i$iv$iv":I
    .local v23, "$i$f$substringWhile":I
    :goto_85
    move/from16 v22, v15

    .end local v15    # "isNegative":Z
    .local v22, "isNegative":Z
    invoke-virtual/range {v16 .. v16}, Ljava/lang/String;->length()I

    move-result v15

    if-ge v5, v15, :cond_d3
    ...
    .local v25, "$this$skipWhile$iv$iv":Ljava/lang/String;
    ...
    .local v20, "length":I
    .local v26, "infinityString":Ljava/lang/String;
    ...
    .end local v24    # "hasSign":Z
    .end local v25    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .end local v26    # "infinityString":Ljava/lang/String;
    .restart local v2    # "nonDigitSymbols":Ljava/lang/String;
    ...
    .restart local v24    # "hasSign":Z
    .restart local v25    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v26    # "infinityString":Ljava/lang/String;
    :cond_df
    nop
    ...
    .end local v23    # "$i$f$substringWhile":I
    move-object v0, v2
    ...
    .restart local v18    # "nonDigitSymbols":Ljava/lang/String;
    .restart local v20    # "length":I
    .restart local v22    # "isNegative":Z
    .restart local v24    # "hasSign":Z
    .restart local v26    # "infinityString":Ljava/lang/String;
    goto/16 :goto_3ac
    ...
    .line 1374
    .local v16, "$i$a$-skipWhile-DurationKt$parseDuration$1":I
    move/from16 v18, v1

    .end local v1    # "afterFirst":Z
    .local v18, "afterFirst":Z
    const/16 v1, 0x20

    if-ne v11, v1, :cond_257
    ...
    .end local v11    # "it":C
    .end local v16    # "$i$a$-skipWhile-DurationKt$parseDuration$1":I
    :goto_258
    if-eqz v1, :cond_261
    ...
    .line 1473
    .end local v1    # "afterFirst":Z
    .restart local v18    # "afterFirst":Z
    :cond_261
    nop
    ...
    .local v16, "allowSpaces":Z
    invoke-virtual {v5}, Ljava/lang/String;->length()I

    move-result v2

    if-ge v1, v2, :cond_2a8
    ...
    .local v20, "$i$f$substringWhile":I
    ...
    .local v21, "$this$skipWhile$iv$iv":Ljava/lang/String;
    invoke-direct {v4, v6, v5}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v4, v2}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    .line 1478
    .end local v20    # "$i$f$substringWhile":I
    .end local v21    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    ...
    .end local v4    # "$i$f$substringWhile":I
    .end local v5    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v20    # "$i$f$substringWhile":I
    .restart local v21    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    :cond_2b0
    nop
    ...
    .line 1380
    .local v17, "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    move/from16 v19, v3

    .end local v3    # "$i$f$substringWhile":I
    .local v19, "$i$f$substringWhile":I
    ...
    .end local v11    # "$i$f$skipWhile":I
    .local v23, "$i$f$skipWhile":I
    const/16 v11, 0x7a

    invoke-direct {v3, v4, v11}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v3, v6}, Lkotlin/ranges/CharRange;->contains(C)Z

    move-result v3

    .end local v6    # "it":C
    .end local v17    # "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    if-eqz v3, :cond_30a
    ...
    .line 1484
    .end local v19    # "$i$f$substringWhile":I
    .end local v21    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .end local v23    # "$i$f$skipWhile":I
    .restart local v3    # "$i$f$substringWhile":I
    .restart local v4    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v11    # "$i$f$skipWhile":I
    :cond_304
    move/from16 v19, v3
    ...
    .end local v4    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .end local v11    # "$i$f$skipWhile":I
    .restart local v19    # "$i$f$substringWhile":I
    .restart local v21    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v23    # "$i$f$skipWhile":I
    :cond_30a
    nop
