...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    new-instance v2, Landroidx/core/location/LocationManagerCompat$$ExternalSyntheticLambda0;

    invoke-direct {v2, v1}, Landroidx/core/location/LocationManagerCompat$$ExternalSyntheticLambda0;-><init>(Landroidx/core/location/LocationManagerCompat$CancellableLocationListener;)V
...
.method private static registerGnssStatusCallback(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    :try_end_3d
    .catchall {:try_start_29 .. :try_end_3d} :catchall_106
    ...
    move-result v0
    :try_end_61
    .catchall {:try_start_40 .. :try_end_61} :catchall_10b
    ...
    :try_end_70
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_64 .. :try_end_70} :catch_bf
    ...
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_71 .. :try_end_84} :catch_bf
    ...
    monitor-exit v6
    :try_end_9b
    .catchall {:try_start_87 .. :try_end_9b} :catchall_10b
    ...
    :try_end_a2
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_9e .. :try_end_a2} :catch_bf
    ...
    throw v4
    :try_end_e4
    .catchall {:try_start_a8 .. :try_end_e4} :catchall_a5
    ...
    monitor-exit v6
    :try_end_10a
    .catchall {:try_start_e6 .. :try_end_10a} :catchall_10b
